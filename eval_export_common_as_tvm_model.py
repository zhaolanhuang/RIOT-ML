...
EXPORT_DIR = "./DeepSliding_TVM_model/stm32f746g-disco-common/"
...
if __name__ == "__main__":
    ...
    for cls in CLS_OF_MODELS:
        SSM_PT_MODEL_PATH = PT_MODEL_DIR + f"/common/{cls.__name__}.pth"
        EXPORT_PATH = EXPORT_DIR + f"/{cls.__name__}/"
        Path(EXPORT_PATH).mkdir(parents=True, exist_ok=True)
        generate_model_c_code(SSM_PT_MODEL_PATH, "stm32f746g-disco", EXPORT_PATH + "default.tar", EXPORT_PATH, {'input': list(cls.DEFAULT_INPUT_SHAPE)} )
